...
**D. 【原文引用】（引用 3-5 段關鍵對話）⚠️ 時間戳必填！**
從逐字稿中選取最關鍵的原句。

**⚠️ 重要：必須從逐字稿複製原始時間戳！**
- 逐字稿格式通常是 "01:05 Speaker:" 或 "03:22 講者名:"
- 請直接複製該時間戳（如 01:05、03:22、15:30 等）
...
3. ✅ 每個 description 是否都包含完整的四個部分？
   ...
   - 【執行細節】3-6 個編號步驟
   - 【會議脈絡】2-3 段背景說明
   - 【原文引用】3-5 段逐字稿引用（⚠️ 必須有時間戳如【15:30】！）
4. ✅ 是否涵蓋了以下類型的任務？
   - 明確行動（要做的事）
   - 客戶/學生跟進
   - 流程/話術改進
